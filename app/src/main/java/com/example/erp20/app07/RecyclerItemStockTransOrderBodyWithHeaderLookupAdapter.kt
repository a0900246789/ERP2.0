...
class RecyclerItemStockTransOrderBodyWithHeaderLookupAdapter(FilterTopic:String,FilterContent:String) :
    RecyclerView.Adapter<RecyclerItemStockTransOrderBodyWithHeaderLookupAdapter.ViewHolder>() {
