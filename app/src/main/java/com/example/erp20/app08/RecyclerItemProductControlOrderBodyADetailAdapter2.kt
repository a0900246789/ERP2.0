...
class RecyclerItemProductControlOrderBodyADetailAdapter2(SelectFilter:String) :
    RecyclerView.Adapter<RecyclerItemProductControlOrderBodyADetailAdapter2.ViewHolder>() {
    ...
    init {
        ...
        data=filter(data)//過濾start_date!=null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemProductControlOrderBodyADetailAdapter2.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_product_control_order_body_a_detail,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemProductControlOrderBodyADetailAdapter2.ViewHolder, position: Int) {
