...
class RecyclerItemVenderShipmentHeaderAdapter() :
    RecyclerView.Adapter<RecyclerItemVenderShipmentHeaderAdapter.ViewHolder>() {
    private var itemData: ShowVenderShipmentHeader =Gson().fromJson(cookie_data.response_data, ShowVenderShipmentHeader::class.java)
    private var data: ArrayList<VenderShipmentHeader> =itemData.data
    var relativeCombobox01=cookie_data.vender_id_ComboboxData

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_vender_shipment_header,parent,false)
        return ViewHolder(v)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.vender_shipment_id.setText(data[position].vender_shipment_id)
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        lateinit var oldData:VenderShipmentHeader
        lateinit var newData:VenderShipmentHeader
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    "編輯"->{
                        ...
                        vender_shipment_id.inputType=InputType.TYPE_CLASS_TEXT
                    ...
                    "完成"->{
                        ...
                        newData.vender_shipment_id=vender_shipment_id.text.toString()
                        vender_shipment_id.inputType=InputType.TYPE_NULL
                        ...
                        edit_Purchase("VenderShipmentHeader",oldData,newData)//更改資料庫資料
                        when(cookie_data.status){
                            ...
                            1->{//失敗
                                ...
                                vender_shipment_id.setText(oldData.vender_shipment_id)
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_Purchase("VenderShipmentHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_Purchase("VenderShipmentHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_Purchase("VenderShipmentHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_Purchase(operation:String,oldData:VenderShipmentHeader,newData:VenderShipmentHeader) {
            val old =JSONObject()
            old.put("poNo",oldData.poNo)
            old.put("purchase_date",oldData.purchase_date)
            old.put("vender_id",oldData.vender_id)
            old.put("vender_shipment_id",oldData.vender_shipment_id)
            ...
            new.put("vender_shipment_id",newData.vender_shipment_id)
        ...
        private fun delete_Purchase(operation:String,deleteData:VenderShipmentHeader) {
            ...
            delete.put("vender_shipment_id",deleteData.vender_shipment_id)
        ...
        private fun lock_Purchase(operation:String,lockData:VenderShipmentHeader) {
            val lock = JSONObject()
            lock.put("poNo",lockData.poNo)
            lock.put("purchase_date",lockData.purchase_date)
            lock.put("vender_id",lockData.vender_id)
            lock.put("vender_shipment_id",lockData.vender_shipment_id)
        ...
        private fun over_Purchase(operation:String,overData:VenderShipmentHeader) {
            val over = JSONObject()
            over.put("poNo",overData.poNo)
            over.put("purchase_date",overData.purchase_date)
            over.put("vender_id",overData.vender_id)
            over.put("vender_shipment_id",overData.vender_shipment_id)
    ...
    fun addItem(addData:VenderShipmentHeader){
