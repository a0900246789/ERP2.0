...
class RecyclerItemMealOrderListHeaderWorkAdapter() :
    RecyclerView.Adapter<RecyclerItemMealOrderListHeaderWorkAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemMealOrderListHeaderWorkAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_meal_order_list_header_work,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemMealOrderListHeaderWorkAdapter.ViewHolder, position: Int) {
        ...
        if( ( ((data[position].attendance)*8)-data[position].total_leave_hours+data[position].number_of_overtime_support ).toInt()==0){
        ...
        holder.can_work_hour.inputType=InputType.TYPE_NULL
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        var attendance_rate_people=itemView.findViewById<TextInputEditText>(R.id.edit_attendance_rate_people)
        var number_of_support=itemView.findViewById<TextInputEditText>(R.id.edit_number_of_support)
        var total_work_hour=itemView.findViewById<TextInputEditText>(R.id.edit_total_work_hour)
        var total_support_hours=itemView.findViewById<TextInputEditText>(R.id.edit_total_support_hours)
        var attendance_rate_hour=itemView.findViewById<TextInputEditText>(R.id.edit_attendance_rate_hour)
       /* var d_meat_meals=itemView.findViewById<TextInputEditText>(R.id.edit_d_meat_meals)
        ...
        var part_rate=itemView.findViewById<TextInputEditText>(R.id.edit_part_rate)
        var can_work_hour=itemView.findViewById<TextInputEditText>(R.id.edit_can_work_hour)
