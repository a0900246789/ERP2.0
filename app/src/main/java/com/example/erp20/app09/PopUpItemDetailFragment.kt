 ...
 */
class PopUpItemDetailFragment(filter_id:String,filter_purchase_order_id:String,filter_prod_ctrl_order_number:String) : DialogFragment() {
    private lateinit var StockTransOrderBody_Simplify_adapter: RecyclerItemStockTransOrderBodySimplifyAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_item_detail, container, false)
    }
                ...
                if( item_id.text.toString().trim().isEmpty() || (cookie_data.item_id_name_ComboboxData.indexOf(item_id.text.toString())==-1) ){
                    ...
                    when(cookie_data.status){
                        0-> {//成功
                            ...
                            StockTransOrderBody_Simplify_adapter.addItem(addData)
