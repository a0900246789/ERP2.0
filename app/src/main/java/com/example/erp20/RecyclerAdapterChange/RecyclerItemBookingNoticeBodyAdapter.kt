...
class RecyclerItemBookingNoticeBodyAdapter() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemBookingNoticeBodyAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_booking_notice_body,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemBookingNoticeBodyAdapter.ViewHolder, position: Int) {
