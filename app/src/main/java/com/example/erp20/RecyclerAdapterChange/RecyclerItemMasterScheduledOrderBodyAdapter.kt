...
class RecyclerItemMasterScheduledOrderBodyAdapter() :
    RecyclerView.Adapter<RecyclerItemMasterScheduledOrderBodyAdapter.ViewHolder>() {
    private var itemData: ShowMasterScheduledOrderBody =Gson().fromJson(cookie_data.response_data, ShowMasterScheduledOrderBody::class.java)
    private var data: ArrayList<MasterScheduledOrderBody> =itemData.data
    var relativeCombobox01=cookie_data.product_type_id_ComboboxData

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemMasterScheduledOrderBodyAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_master_scheduled_order_body,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemMasterScheduledOrderBodyAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        lateinit var oldData:MasterScheduledOrderBody
        lateinit var newData:MasterScheduledOrderBody
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    "編輯"->{
                        ...
                        pre_delivery_date.requestFocus()
                        edit_btn.text = "完成"
                    }
                    "完成"->{
                        newData= MasterScheduledOrderBody()
                        ...
                        edit_MasterScheduledOrder("MasterScheduledOrderBody",oldData,newData)//更改資料庫資料
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_MasterScheduledOrder("MasterScheduledOrderBody",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_MasterScheduledOrder("MasterScheduledOrderBody",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_MasterScheduledOrder("MasterScheduledOrderBody",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_MasterScheduledOrder(operation:String,oldData: MasterScheduledOrderBody,newData: MasterScheduledOrderBody) {
            val old =JSONObject()
        ...
        private fun delete_MasterScheduledOrder(operation:String,deleteData: MasterScheduledOrderBody) {
        ...
        private fun lock_MasterScheduledOrder(operation:String,lockData: MasterScheduledOrderBody) {
            val lock = JSONObject()
        ...
        private fun over_MasterScheduledOrder(operation:String,overData:MasterScheduledOrderBody) {
            val over = JSONObject()
    ...
    fun addItem(addData: MasterScheduledOrderBody){
