...
class RecyclerItemCustomerOrderHeaderAdapter() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemCustomerOrderHeaderAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_customer_order_header,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemCustomerOrderHeaderAdapter.ViewHolder, position: Int) {

        //Log.d("GSON", "msg: ${itemData.data[position]}\n")
        holder.poNo.setText(data[position].poNo)
        holder.poNo.inputType=InputType.TYPE_NULL
        holder.order_date.setText(data[position].order_date)
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        var customer_id=itemView.findViewById<AutoCompleteTextView>(R.id.edit_customer_id)
