...
class RecyclerItemCustomerForecastListHeaderAdapter() :
    RecyclerView.Adapter<RecyclerItemCustomerForecastListHeaderAdapter.ViewHolder>() {
    private var itemData: ShowCustomerForecastListHeader =Gson().fromJson(cookie_data.response_data, ShowCustomerForecastListHeader::class.java)
    private var data: ArrayList<CustomerForecastListHeader> =itemData.data
    var relativeCombobox01=cookie_data.customer_id_ComboboxData

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemCustomerForecastListHeaderAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_customer_forecast_list_header,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemCustomerForecastListHeaderAdapter.ViewHolder, position: Int) {
        ...
        holder.custom_id.setText(data[position].custom_id)
        holder.custom_id.inputType=InputType.TYPE_NULL
        holder.forecast_basis.setText(data[position].forecast_basis)
        holder.forecast_basis.inputType=InputType.TYPE_NULL
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        var custom_id=itemView.findViewById<AutoCompleteTextView>(R.id.edit_custom_id)
        var forecast_basis=itemView.findViewById<TextInputEditText>(R.id.edit_forecast_basis)
        ...
        lateinit var oldData:CustomerForecastListHeader
        lateinit var newData:CustomerForecastListHeader
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    "編輯"->{
                        ...
                        forecast_basis.inputType=InputType.TYPE_CLASS_TEXT
                    ...
                    "完成"->{
                        newData= CustomerForecastListHeader()
                        ...
                        newData.custom_id=custom_id.text.toString()
                        custom_id.setAdapter(null)
                        newData.forecast_basis=forecast_basis.text.toString()
                        forecast_basis.inputType=InputType.TYPE_NULL
                        ...
                        edit_CustomerForecastList("CustomerForecastList","header",oldData,newData)//更改資料庫資料
                        when(cookie_data.status){
                            ...
                            1->{//失敗
                                ...
                                custom_id.setText(oldData.custom_id)
                                forecast_basis.setText(oldData.forecast_basis)
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_CustomerForecastList("CustomerForecastList","header",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_CustomerForecastList("CustomerForecastList","header",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_CustomerForecastList("CustomerForecastList","header",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_CustomerForecastList(operation:String,target:String,oldData:CustomerForecastListHeader,newData:CustomerForecastListHeader) {
            val old =JSONObject()
            old.put("_id",oldData._id)
            old.put("date",oldData.date)
            old.put("custom_id",oldData.custom_id)
            old.put("forecast_basis",oldData.forecast_basis)
            ...
            new.put("custom_id",newData.custom_id)
            new.put("forecast_basis",newData.forecast_basis)
        ...
        private fun delete_CustomerForecastList(operation:String,target:String,deleteData:CustomerForecastListHeader) {
            val delete = JSONObject()
            delete.put("_id",deleteData._id)
            delete.put("date",deleteData.date)
            delete.put("custom_id",deleteData.custom_id)
            delete.put("forecast_basis",deleteData.forecast_basis)
        ...
        private fun lock_CustomerForecastList(operation:String,target:String,lockData:CustomerForecastListHeader) {
            val lock = JSONObject()
            lock.put("_id",lockData._id)
            lock.put("date",lockData.date)
            lock.put("custom_id",lockData.custom_id)
            lock.put("forecast_basis",lockData.forecast_basis)
        ...
        private fun over_CustomerForecastList(operation:String,target:String,overData:CustomerForecastListHeader) {
            val over = JSONObject()
            over.put("_id",overData._id)
            over.put("date",overData.date)
            over.put("custom_id",overData.custom_id)
            over.put("forecast_basis",overData.forecast_basis)
    ...
    fun addItem(addData:CustomerForecastListHeader){
