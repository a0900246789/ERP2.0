...
class RecyclerItemMasterScheduledOrderHeaderAdapter() :
    RecyclerView.Adapter<RecyclerItemMasterScheduledOrderHeaderAdapter.ViewHolder>() {
    private var itemData: ShowMasterScheduledOrderHeader =Gson().fromJson(cookie_data.response_data, ShowMasterScheduledOrderHeader::class.java)
    private var data: ArrayList<MasterScheduledOrderHeader> =itemData.data
    var relativeCombobox01=cookie_data.product_type_id_ComboboxData

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemMasterScheduledOrderHeaderAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_master_scheduled_order_header,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemMasterScheduledOrderHeaderAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        lateinit var oldData:MasterScheduledOrderHeader
        lateinit var newData:MasterScheduledOrderHeader
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    ...
                    "完成"->{
                        newData= MasterScheduledOrderHeader()
                        ...
                        edit_MasterScheduledOrder("MasterScheduledOrderHeader",oldData,newData)//更改資料庫資料
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_MasterScheduledOrder("MasterScheduledOrderHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_MasterScheduledOrder("MasterScheduledOrderHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_MasterScheduledOrder("MasterScheduledOrderHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_MasterScheduledOrder(operation:String,oldData:MasterScheduledOrderHeader,newData:MasterScheduledOrderHeader) {
            val old =JSONObject()
        ...
        private fun delete_MasterScheduledOrder(operation:String,deleteData:MasterScheduledOrderHeader) {
        ...
        private fun lock_MasterScheduledOrder(operation:String,lockData:MasterScheduledOrderHeader) {
            val lock = JSONObject()
        ...
        private fun over_MasterScheduledOrder(operation:String,overData:MasterScheduledOrderHeader) {
            val over = JSONObject()
    ...
    fun addItem(addData:MasterScheduledOrderHeader){
