...
class RecyclerItemPurchasePreparationListHeaderAdapter() :
    RecyclerView.Adapter<RecyclerItemPurchasePreparationListHeaderAdapter.ViewHolder>() {
    private var itemData: ShowPurchasePreparationListHeader =Gson().fromJson(cookie_data.response_data, ShowPurchasePreparationListHeader::class.java)
    private var data: ArrayList<PurchasePreparationListHeader> =itemData.data
    var relativeCombobox01=cookie_data.vender_id_ComboboxData

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemPurchasePreparationListHeaderAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_purchase_preparation_list_header,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemPurchasePreparationListHeaderAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        lateinit var oldData:PurchasePreparationListHeader
        lateinit var newData:PurchasePreparationListHeader
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    ...
                    "完成"->{
                        newData= PurchasePreparationListHeader()
                        ...
                        edit_Purchase("PurchasePreparationListHeader",oldData,newData)//更改資料庫資料
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_Purchase("PurchasePreparationListHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_Purchase("PurchasePreparationListHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_Purchase("PurchasePreparationListHeader",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_Purchase(operation:String,oldData:PurchasePreparationListHeader,newData:PurchasePreparationListHeader) {
            val old =JSONObject()
        ...
        private fun delete_Purchase(operation:String,deleteData:PurchasePreparationListHeader) {
        ...
        private fun lock_Purchase(operation:String,lockData:PurchasePreparationListHeader) {
            val lock = JSONObject()
        ...
        private fun over_Purchase(operation:String,overData:PurchasePreparationListHeader) {
            val over = JSONObject()
    ...
    fun addItem(addData:PurchasePreparationListHeader){
