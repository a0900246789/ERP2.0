...
class RecyclerItemStockTransOrderHeaderSimplifyAdapter3(Filter_pline:String,Filter_date:String) :
    RecyclerView.Adapter<RecyclerItemStockTransOrderHeaderSimplifyAdapter3.ViewHolder>() {
    ...
    init {
        ...
        data=filter(data,Filter_date,Filter_pline)//過濾date<filter && main_trans_code!=M06
        data=sort(data)

    }

    fun filter(data:ArrayList<StockTransOrderHeader>,filter_date:String,filter_pline:String): ArrayList<StockTransOrderHeader>{
        ...
        for(i in 0 until data.size){
            ...
            if(date1.compareTo(date2)>=0 && data[i].main_trans_code=="M02" && data[i].dept==filter_pline){
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            println(ArrayList)
            var arrayAdapter03= ArrayAdapter(itemView.context,R.layout.combobox_item,ArrayList)
           ...
           /* var relativeCombobox05:ArrayList<String> = ArrayList<String>()
            ...
            item_detail_btn.setOnClickListener {
                var dialogF= PopUpItemDetailFragment3(data[adapterPosition]._id,data[adapterPosition].purchase_order_id,data[adapterPosition].prod_ctrl_order_number)
