...
import com.example.erp20.ClassFragment.STK.STK06changeFragment
import com.example.erp20.ClassFragment.STK.STK06maintainFragment
import com.google.android.material.bottomnavigation.BottomNavigationView

class STK_Activity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_stk)
        val STK06maintainFragment= STK06maintainFragment()
        val STK06changeFragment= STK06changeFragment()
        currentFragment(STK06maintainFragment)
        //bottom nav
        ...
        navView.setOnNavigationItemSelectedListener {
            when(it.itemId) {
                ...
                R.id.nav_change_data_maintain -> {
                    currentFragment(STK06changeFragment)
