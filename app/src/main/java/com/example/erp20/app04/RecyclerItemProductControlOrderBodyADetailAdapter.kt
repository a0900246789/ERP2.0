...
class RecyclerItemProductControlOrderBodyADetailAdapter(SelectFilter:String) :
    RecyclerView.Adapter<RecyclerItemProductControlOrderBodyADetailAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemProductControlOrderBodyADetailAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_product_control_order_body_a_detail,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemProductControlOrderBodyADetailAdapter.ViewHolder, position: Int) {
