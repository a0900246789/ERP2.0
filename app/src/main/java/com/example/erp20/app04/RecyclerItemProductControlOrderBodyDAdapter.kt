...
class RecyclerItemProductControlOrderBodyDAdapter() :
    RecyclerView.Adapter<RecyclerItemProductControlOrderBodyDAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemProductControlOrderBodyDAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_product_control_order_body_d,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemProductControlOrderBodyDAdapter.ViewHolder, position: Int) {
