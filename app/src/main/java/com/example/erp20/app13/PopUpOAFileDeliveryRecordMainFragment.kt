 ...
 * Use the [PopUpOAFileDeliveryRecordMainFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpOAFileDeliveryRecordMainFragment(filter_trackingNO:String) : DialogFragment() {
    private lateinit var OAFileDeliveryRecordSecond_adapter: RecyclerItemOAFileDeliveryRecordSecondAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_pop_up_o_a_file_delivery_record_main,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        OAFileDeliveryRecordSecond_adapter= RecyclerItemOAFileDeliveryRecordSecondAdapter()
        recyclerView.adapter=OAFileDeliveryRecordSecond_adapter//找對應itemAdapter
                    ...
                    var job = CoroutineScope(Dispatchers.IO).launch {
                        ...
                        when(json.status){
                            0->{
                                ...
                                cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData.removeAll(cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData)
                                for(i in 0 until data.size){
