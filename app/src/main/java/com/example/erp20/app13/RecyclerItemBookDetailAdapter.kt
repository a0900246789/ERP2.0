...
class RecyclerItemBookDetailAdapter(FilterOA1:String) :
    RecyclerView.Adapter<RecyclerItemBookDetailAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_book_detail,parent,false)
        return ViewHolder(v)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(cookie_data.OAFileDeliveryRecordBody_booking_noticeNo_ComboboxData.indexOf(data[position].notice_number)!=-1){
            holder.trackingNo.setText(cookie_data.OAFileDeliveryRecordBody_trackingNo_ComboboxData[cookie_data.OAFileDeliveryRecordBody_booking_noticeNo_ComboboxData.indexOf(data[position].notice_number)])
        }
        else{
            holder.trackingNo.setText("")
        }
        ...
        init {
          ...
          /*  //編輯按鈕
            ...
            book_info_btn.setOnClickListener {
                ...
                var dialogF= PopUpBookInfoFragment(FilterOA1)
