...
class RecyclerItemOAFileDeliveryRecordAdapter(notice_number:String) :
    RecyclerView.Adapter<RecyclerItemOAFileDeliveryRecordAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_oa_file_delivery_record,parent,false)
        return ViewHolder(v)
