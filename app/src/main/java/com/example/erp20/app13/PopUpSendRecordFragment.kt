 ...
 * Use the [PopUpSendRecordFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpSendRecordFragment(notice_number:String) : DialogFragment() {
    private lateinit var OAFileDeliveryRecord_adapter: RecyclerItemOAFileDeliveryRecordAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_send_record, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var Filter_id=""
        if(cookie_data.OAFileDeliveryRecordBody_booking_noticeNo_ComboboxData.indexOf(notice_number)!=-1){
            Filter_id=cookie_data.OAFileDeliveryRecordBody_trackingNo_ComboboxData[cookie_data.OAFileDeliveryRecordBody_booking_noticeNo_ComboboxData.indexOf(notice_number)]
        }
        show_header_body_filter("OAFileDeliveryRecordHeader","condition","False",Filter_id)

        var popUpName=view.findViewById<TextView>(R.id.popUpName)
        popUpName.text="文件寄送紀錄"
        val recyclerView=view.findViewById<RecyclerView>(R.id.recyclerView)
        recyclerView.layoutManager= LinearLayoutManager(view.context)//設定Linear格式
        OAFileDeliveryRecord_adapter= RecyclerItemOAFileDeliveryRecordAdapter(notice_number)
        recyclerView.adapter=OAFileDeliveryRecord_adapter//找對應itemAdapter
    ...
    /*companion object {
         ...
         * @return A new instance of fragment PopUpSendRecordFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PopUpSendRecordFragment().apply {
