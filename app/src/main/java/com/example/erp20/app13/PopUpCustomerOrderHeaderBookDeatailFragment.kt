 ...
 * Use the [PopUpCustomerOrderHeaderBookDeatailFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpCustomerOrderHeaderBookDeatailFragment(filter_trackingNO:String,Filter_PoNo:String) : DialogFragment() {
    private lateinit var CustomerOrderHeaderBookDetail_adapter: RecyclerItemCustomerOrderHeaderBookDetailAdapter
    var filter_trackingNO=filter_trackingNO
    var Filter_PoNo=Filter_PoNo
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_pop_up_customer_order_header_book_deatail,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        show_header_body_filter("OAFileDeliveryRecordBody","condition","False",filter_trackingNO)
        ...
        CustomerOrderHeaderBookDetail_adapter= RecyclerItemCustomerOrderHeaderBookDetailAdapter(Filter_PoNo)
        recyclerView.adapter=CustomerOrderHeaderBookDetail_adapter//找對應itemAdapter
       ...
       /* //刷新
        ...
        refresh_btn?.setOnClickListener {
            show_header_body_filter("OAFileDeliveryRecordBody","condition","False",filter_trackingNO)
            CustomerOrderHeaderBookDetail_adapter= RecyclerItemCustomerOrderHeaderBookDetailAdapter()
            recyclerView.adapter=CustomerOrderHeaderBookDetail_adapter//找對應itemAdapter
        }*/
       /* //新增
        ...
        add_btn?.setOnClickListener {
            cookie_data.recyclerView=recyclerView
            val item = LayoutInflater.from(activity).inflate(R.layout.recycler_item_oa_file_delivery_record_second, null)
            ...
            val arrayAdapter01= ArrayAdapter(item.context,R.layout.combobox_item, cookie_data.BookingNoticeHeader_notice_numbe_ComboboxData)

            var booking_noticeNo=item.findViewById<AutoCompleteTextView>(R.id.edit_booking_noticeNo)
            ...
            trackingNo.setText(filter_trackingNO)
            ...
            booking_noticeNo.setOnItemClickListener { parent, view, position, id ->
                ...
                if(customer_poNo.text.toString()!="" && cookie_data.CustomerOrderHeader_poNo_ComboboxData.indexOf(customer_poNo.text.toString())!=-1 && cookie_data.CustomerOrderHeader_swe_ComboboxData[cookie_data.CustomerOrderHeader_poNo_ComboboxData.indexOf(customer_poNo.text.toString())]!=null){
                    //date
                    var readDateString=
                        cookie_data.CustomerOrderHeader_swe_ComboboxData[cookie_data.CustomerOrderHeader_poNo_ComboboxData.indexOf(customer_poNo.text.toString())]
            ...
            mAlertDialog.setNegativeButton("確定") { dialog, id ->
                val addData= OAFileDeliveryRecordBody()
                addData.trackingNo=filter_trackingNO
                addData.booking_noticeNo=booking_noticeNo.text.toString()

                addData.remark=remark.text.toString()

                add_header_body("OAFileDeliveryRecordBody",addData)
                when(cookie_data.status){
                    0-> {//成功
                        OAFileDeliveryRecordSecond_adapter.addItem(addData)
    ...
    private fun show_header_body_filter(operation:String,view_type:String,view_hide:String,selectedfilter:String) {
        when(operation){
            "BookingNoticeHeader"->{
                ...
                filter.put("oa_referenceNO1",selectedfilter)
            ...
            "OAFileDeliveryRecordBody"->{
                val filter = JSONObject()
                filter.put("trackingNo",selectedfilter)
                val body = FormBody.Builder()
                    .add("username", cookie_data.username)
                    .add("operation", operation)
                    .add("action", cookie_data.Actions.VIEW)
    ...
    private fun <T>add_header_body(operation:String,addData:T) {
        ...
        when(addData)
        {
            ...
            is OAFileDeliveryRecordBody ->{
                ...
                add.put("booking_noticeNo",addData.booking_noticeNo)
                    ...
                    var job = CoroutineScope(Dispatchers.IO).launch {
                        ...
                        when(json.status){
                            0->{
                                ...
                                cookie_data.BookingNoticeHeader_id_ComboboxData.removeAll(
                                    cookie_data.BookingNoticeHeader_id_ComboboxData)
                                cookie_data.BookingNoticeHeader_notice_numbe_ComboboxData.removeAll(
                                    cookie_data.BookingNoticeHeader_notice_numbe_ComboboxData)
                                cookie_data.BookingNoticeHeader_customer_poNo_ComboboxData.removeAll(
                                    cookie_data.BookingNoticeHeader_customer_poNo_ComboboxData)
                                cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData.removeAll(
                                    cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData)
                                for(i in 0 until data.size){
                                    ...
                                    cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData.add(data[i].oa_referenceNO1)
                                }
                                // Log.d("GSON", "msg:${cookie_data.BookingNoticeHeader_oa_referenceNO1_ComboboxData}")
                            }
                            1->{
                                var fail= Gson().fromJson(responseinfo, Response::class.java)
                                cookie_data.msg=fail.msg
    ...
    /*companion object {
         ...
         * @return A new instance of fragment PopUpBookDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PopUpBookDetailFragment().apply {
