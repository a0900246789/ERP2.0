 ...
 */
class PopUpContList2Fragment(filter_id:String,notice_number:String,customer_poNo:String,swe:String) : DialogFragment() {
    private lateinit var BookingNoticeBody_ContList2_adapter: RecyclerItemBookingNoticeBodyContList2Adapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_cont_list2, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        BookingNoticeBody_ContList2_adapter= RecyclerItemBookingNoticeBodyContList2Adapter(notice_number, customer_poNo, swe)
        recyclerView.adapter=BookingNoticeBody_ContList2_adapter//找對應itemAdapter
                    ...
                    var job = CoroutineScope(Dispatchers.IO).launch {
                        ...
                        when(json.status){
                            0->{
                                ...
                                cookie_data.cont_age_ComboboxData.removeAll(cookie_data.cont_age_ComboboxData)
                                for(i in 0 until data.size){
                                    cookie_data.cont_id_ComboboxData.add(data[i].cont_code_name)
                                    cookie_data.cont_code_ComboboxData.add(data[i].cont_code)
                                    cookie_data.cont_age_ComboboxData.add(data[i].age)
                                }
                                //Log.d("GSON", "msg:${comboboxData}")
                            }
                            1->{
