 ...
 * Use the [PopUpBookInfoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpBookInfoFragment(filterOA1:String) : DialogFragment() {
    private lateinit var BookInfo_adapter: RecyclerItemBookInfoAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_book_info, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        show_header_body_filter("BookingNoticeHeader","condition","False",filterOA1)
        ...
        BookInfo_adapter= RecyclerItemBookInfoAdapter()
        recyclerView.adapter=BookInfo_adapter//找對應itemAdapter
    ...
    /*companion object {
         ...
         * @return A new instance of fragment PopUpBookInfoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PopUpBookInfoFragment().apply {
