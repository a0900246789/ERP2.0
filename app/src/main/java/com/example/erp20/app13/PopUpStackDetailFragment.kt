...
import com.example.erp20.app05.RecyclerItemStackingControlListBodyDetailAdapter
 ...
 * Use the [PopUpStackDetailFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpStackDetailFragment(Filter_id:String,FilterCont_Code:String,V:Int) : DialogFragment() {
    private lateinit var StackingControlListBodyDetail_adapter: RecyclerItemStackingControlListBodyDetailAdapter
    var Filter_id=Filter_id
    var FilterCont_Code=FilterCont_Code
    var V=V
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_stack_detail, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        show_header_body_filter("StackingControlListBody","condition","False",Filter_id)
        ...
        StackingControlListBodyDetail_adapter= RecyclerItemStackingControlListBodyDetailAdapter(FilterCont_Code)
        recyclerView.adapter=StackingControlListBodyDetail_adapter//找對應itemAdapter
        cookie_data.recyclerView=recyclerView
        //關閉
        var dismiss=view.findViewById<Button>(R.id.dismiss_btn)
        dismiss?.setOnClickListener {
            if(V==2){
                cookie_data.recyclerView=cookie_data.second_recyclerView
            }
            else if(V==3){
                cookie_data.recyclerView=cookie_data.third_recyclerView
            }
                    ...
                    var job = CoroutineScope(Dispatchers.IO).launch {
                        ...
                        when(json.status){
                            0->{
                                ...
                                cookie_data.product_name_ComboboxData.removeAll(cookie_data.product_name_ComboboxData)
                                for(i in 0 until data.size){
                                    cookie_data.product_id_ComboboxData.add(data[i]._id)
                                    cookie_data.product_name_ComboboxData.add(data[i].product_name)
                                }
                                //Log.d("GSON", "msg:${comboboxData}")
                            }
                            1->{
   ...
   /* companion object {
         ...
         * @return A new instance of fragment PopUpStackDetailFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PopUpStackDetailFragment().apply {
