...
class RecyclerItemBookingNoticeBodyContList2Adapter(notice_number:String,customer_poNo:String,swe:String) :
    RecyclerView.Adapter<RecyclerItemBookingNoticeBodyContList2Adapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_booking_notice_body_cont_list2,parent,false)
        return ViewHolder(v)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(cookie_data.cont_code_ComboboxData.indexOf(data[position].cont_code)!=-1){
            holder.age.setText(cookie_data.cont_age_ComboboxData[
                    cookie_data.cont_code_ComboboxData.indexOf(
                        data[position].cont_code)])
        }
        else{
            holder.age.setText("")
        ...
        init {
           ...
           /* //編輯按鈕
            ...
            stack_detail_btn.setOnClickListener {
                ...
                cookie_data.third_recyclerView=cookie_data.recyclerView
                var dialogF= PopUpStackDetailFragment(headerID,cont_code.text.toString(),3)
