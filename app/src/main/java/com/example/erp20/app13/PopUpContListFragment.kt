...
import com.example.erp20.app06.RecyclerItemStockTransOrderBodySimplifyAdapter3
 ...
 * Use the [PopUpContListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PopUpContListFragment(filter_id:String,notice_number:String,customer_poNo:String,swe:String) : DialogFragment() {
    private lateinit var BookingNoticeBody_ContList_adapter: RecyclerItemBookingNoticeBodyContListAdapter
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_pop_up_cont_list, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        show_header_body_filter("BookingNoticeBody","condition","False",Filter_id)
        show_relative_combobox("ContNo","all","False", ContNo())
        show_relative_combobox("StackingControlListHeader","all","False", StackingControlListHeader())
        ...
        BookingNoticeBody_ContList_adapter= RecyclerItemBookingNoticeBodyContListAdapter(notice_number, customer_poNo, swe)
        recyclerView.adapter=BookingNoticeBody_ContList_adapter//找對應itemAdapter
        ...
        add_btn?.setOnClickListener {
            cookie_data.recyclerView=recyclerView
            val item = LayoutInflater.from(activity).inflate(R.layout.recycler_item_booking_notice_body_cont_list, null)
            ...
            var cont_type=item.findViewById<TextInputEditText>(R.id.edit_cont_type)
            ...
            var Notice_number=item.findViewById<TextInputEditText>(R.id.edit_notice_number)
            Notice_number.setText(notice_number)
            Notice_number.inputType=InputType.TYPE_NULL
            var Customer_poNo=item.findViewById<TextInputEditText>(R.id.edit_customer_poNo)
            Customer_poNo.setText(customer_poNo)
            ...
            mAlertDialog.setNegativeButton("確定") { dialog, id ->
                    ...
                    when(cookie_data.status){
                        0-> {//成功
                            BookingNoticeBody_ContList_adapter.addItem(addData)
    ...
    /*companion object {
         ...
         * @return A new instance of fragment PopUpContListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PopUpContListFragment().apply {
