...
class RecyclerItemProductControlOrderBodyCAdapter() :
    RecyclerView.Adapter<RecyclerItemProductControlOrderBodyCAdapter.ViewHolder>() {
    private var itemData: ShowProductControlOrderBody_C =Gson().fromJson(cookie_data.response_data, ShowProductControlOrderBody_C::class.java)
    private var data: ArrayList<ProductControlOrderBody_C> =itemData.data
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerItemProductControlOrderBodyCAdapter.ViewHolder {
        val v= LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_product_control_order_body_c,parent,false)
        return ViewHolder(v)

    }

    override fun onBindViewHolder(holder: RecyclerItemProductControlOrderBodyCAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        lateinit var oldData:ProductControlOrderBody_C
        lateinit var newData:ProductControlOrderBody_C
        init {
            ...
            edit_btn.setOnClickListener {
                when(edit_btn.text){
                    ...
                    "完成"->{
                        newData= ProductControlOrderBody_C()
                        ...
                        edit_ProductControlOrder("ProductControlOrderBody_C",oldData,newData)//更改資料庫資料
            ...
            deletebtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    delete_ProductControlOrder("ProductControlOrderBody_C",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
            ...
            lockbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    lock_ProductControlOrder("ProductControlOrderBody_C",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
                            lock.setText("true")
            ...
            overbtn.setOnClickListener {
                ...
                mAlertDialog.setNegativeButton("YES") { dialog, id ->
                    over_ProductControlOrder("ProductControlOrderBody_C",data[adapterPosition])
                    when(cookie_data.status){
                        0-> {//成功
        ...
        private fun edit_ProductControlOrder(operation:String,oldData:ProductControlOrderBody_C,newData:ProductControlOrderBody_C) {
            val old =JSONObject()
        ...
        private fun delete_ProductControlOrder(operation:String,deleteData:ProductControlOrderBody_C) {
        ...
        private fun lock_ProductControlOrder(operation:String,lockData:ProductControlOrderBody_C) {
            val lock = JSONObject()
        ...
        private fun over_ProductControlOrder(operation:String,overData:ProductControlOrderBody_C) {
            val over = JSONObject()
    ...
    fun addItem(addData:ProductControlOrderBody_C){
